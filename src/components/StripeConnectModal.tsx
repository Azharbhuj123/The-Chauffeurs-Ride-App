  ...
  const handleNavigationStateChange = useCallback(
    (navState: WebViewNavigation) => {
      ...
      if (url.includes('stripe-connect-success')) {
        ...
        // ✅ No navigation needed — modal closes automatically
        // StripeWarningBox hides because chargesEnabled becomes true
      }
      ...
      <SafeAreaView style={styles.fullScreen}>
        ...
        {connectState.status === 'webview' && (
          <WebView
            ...
            originWhitelist={['https://*.stripe.com', `${APP_SCHEME}://*`]}
            javaScriptEnabled
            domStorageEnabled
